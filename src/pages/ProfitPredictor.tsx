...
export default function ProfitPredictor() {
  return (
    <div className="pb-24 max-w-lg mx-auto">
      <PageHeader title="📊 Profit Predictor" subtitle="AI-powered smart decisions" />
      ...
      <div className="px-4 space-y-4">
        ...
        >
          <h3 className="font-bold text-base flex items-center gap-2">
            <Lightbulb className="w-5 h-5" /> AI Recommendation
          </h3>
          <p className="text-sm opacity-90 mt-2 leading-relaxed">
            Based on your soil type, weather forecast, and market trends — <strong>Onion</strong> gives the best ROI this season. Consider allocating 40% of land to onion and 30% each to wheat and maize.
          </p>
        </motion.div>
            ...
            >
              <div className="flex items-center justify-between mb-2">
                ...
                <span className={`text-xs font-bold px-2 py-0.5 rounded-full ${
                  ...
                  c.verdict.includes("High") ? "bg-warning/15 text-warning" :
