...
const schemes = [
  ...
  },
  {
    ...
    benefit: "Up to ₹2L crop protection",
    eligibility: "✅ You qualify",
    status: "apply",
...
export default function Schemes() {
  return (
    <div className="pb-24 max-w-lg mx-auto">
      <PageHeader title="🏛️ Government Schemes" subtitle="Auto-matched to your profile" />
      ...
      <div className="px-4 space-y-4">
        ...
        >
          ...
          <p className="text-sm text-foreground">
            <span className="font-bold">AI Auto-Matched</span> — Based on your profile, land size, and crop history, you qualify for these schemes.
          </p>
        </motion.div>
        ...
        {schemes.map((s, i) => (
          ...
          >
            ...
            <Button
              className={`w-full rounded-xl text-sm h-10 font-bold ${
                s.status === "active"
            ...
            >
              {s.status === "active" ? "✅ Already Enrolled" : <>Apply Now <ArrowRight className="w-4 h-4 ml-1" /></>}
            </Button>
          </motion.div>
        ))}
      </div>
