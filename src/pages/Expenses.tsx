...
const totalSpent = "₹7,400";

export default function Expenses() {
  return (
    <div className="pb-24 max-w-lg mx-auto">
      <PageHeader title="📸 Expense Tracker" subtitle="Photo-based, no typing needed" />
      ...
      <div className="px-4 space-y-4">
        ...
        >
          <div>
            ...
            <p className="text-3xl font-black">{totalSpent}</p>
            <p className="text-xs opacity-70 mt-1">12 entries</p>
          </div>
          <Button className="bg-primary-foreground/20 hover:bg-primary-foreground/30 text-primary-foreground rounded-xl">
            <Camera className="w-5 h-5 mr-2" /> Add Receipt
          </Button>
        </motion.div>
