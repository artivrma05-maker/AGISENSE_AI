...
export default function Community() {
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      setMessages((prev) => [
        ...
        {
          role: "ai",
          content: "I understand your question. Let me analyze this and provide the best advice for your specific region and soil type. 🌱",
  ...
  return (
    <div className="flex flex-col h-[100dvh] max-w-lg mx-auto">
      <PageHeader title="💬 AI Expert Chat" subtitle="Ask AI or connect with local experts" />
        ...
        {messages.map((msg, i) => (
          ...
          >
            ...
            <div className={`max-w-[75%] rounded-2xl px-3.5 py-2.5 ${
              ...
              {msg.role === "expert" && (
                <p className="text-[10px] font-bold text-warning mb-1">🧑‍🔬 Expert</p>
              )}
