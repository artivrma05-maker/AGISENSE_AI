...
const forecast = [
  { day: "Today", temp: "32°C", icon: "☀️", rain: "5%" },
  { day: "Tomorrow", temp: "30°C", icon: "⛅", rain: "25%" },
...
export default function WeatherAlerts() {
  return (
    <div className="pb-24 max-w-lg mx-auto">
      <PageHeader title="🌤️ Weather & Alerts" subtitle="Hyperlocal village-level forecast" />
      ...
      <div className="px-4 space-y-4">
        ...
        >
          <p className="text-xs opacity-70 mb-1">📍 Your Village</p>
          ...
          <div className="flex gap-4 mt-4 text-xs">
            <span className="flex items-center gap-1"><Thermometer className="w-3.5 h-3.5" /> Feels 35°C</span>
        ...
        <div className="bg-card rounded-2xl p-4 shadow-card">
          <h3 className="font-bold text-sm mb-3">5-Day Forecast</h3>
