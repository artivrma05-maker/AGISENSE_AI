...
const bn: TranslationStrings = {
  ...
  navHome: "হোম", navDetect: "সনাক্ত", navWeather: "আবহাওয়া", navChat: "চ্যাট", navProfile: "প্রোফাইল",
...
const te: TranslationStrings = {
  ...
  navHome: "హోమ్", navDetect: "గుర్తించు", navWeather: "వాతావరణం", navChat: "చాట్", navProfile: "ప్రొఫైల్",
...
const mr: TranslationStrings = {
  ...
  navHome: "होम", navDetect: "ओळखा", navWeather: "हवामान", navChat: "चॅट", navProfile: "प्रोफाइल",
...
const ta: TranslationStrings = {
  ...
  navHome: "முகப்பு", navDetect: "கண்டறி", navWeather: "வானிலை", navChat: "அரட்டை", navProfile: "சுயவிவரம்",
